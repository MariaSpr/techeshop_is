...
$man = $_GET['q'];
$sql="SELECT * FROM prod_info WHERE prodName LIKE '%$man%'";
...
<head>
	<meta charset="UTF-8">
	<title><?php echo "$man"; ?> products</title>
...
<body>
	...
	<!-- apple products -->
	<p id="arr">SEARCH RESULTS FOR: <?php echo strtoupper($man); ?></p>
	<div id="br"></div>
	<?php
 		while($row = mysqli_fetch_array($result)) {
 			echo ("	<div class='prod_box'>
 					...
 					<button type='button' onclick='saveToCart(&#39;".$row['prodID']."&#39;,&#39;".$row['prodName']."&#39;,&#39;".$row['prodPrice']."&#39;)' class='buy'><span class='fa fa-shopping-cart'></span></button>
