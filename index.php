...
$sql = "SELECT * FROM prod_info ORDER BY whenAdded DESC";
...
<body>
	...
	<a href="index.php">
		...
		id="account"><span class="fa fa-user" id="acc"></span><p>LOGIN</p></button>
		...
		<div class="banner">
			<ul>
				<li><img src="img/alphasl.jpg" alt="alphasl" width="940" height="250"></li>
				<li><img src="img/iphone6sl.jpg" alt="iphone" width="940" height="250"></li>
				<li><img src="img/xperiasl.jpg" alt="xperia" width="940" height="250"></li>
				<li><img src="img/ipadairsl.jpg" alt="ipad" width="940" height="250"></li>
				<li><img src="img/note4sl.jpg" alt="note4" width="940" height="250"></li>
			</ul>
		</div> <!-- end of banner -->
		<br>
	</header>
 ...
 <?php
		...
		while($row = mysqli_fetch_array($result)) {
			...
			echo ("	<div class='prod_box'>
					<div class='frame'>
						<img src='img/".$row['prodPic']."' alt='s6' width='162' height='168'>
					</div>
					<p class='title'>".$row['prodName']."</p>
					<div class='price'>".$row['prodPrice']."€</div>
					<button type='button' class='buy'><span class='fa fa-shopping-cart' onclick='saveToCart(&#39;".$row['prodID']."&#39;,&#39;".$row['prodName']."&#39;,&#39;".$row['prodPrice']."&#39;)'></span></button>
					<a href='infoPage.php?prodID=".$row['prodID']."'><button type='button' class='info'><span class='fa fa-info-circle'></span></button></a>
				</div> ");
		}
 ...
 ?>
	...
	<div class="prod_box">
		<div class="frame">
			<img src="img/s6.png" alt="s6" width="162" height="168">
		</div>

		<p class="title">GALAXY S6</p>
	...
	<div class="prod_box">
		<div class="frame">
			<img src="img/lgg4.png" alt="g4" width="162" height="162">
		</div>

		<p class="title">LG G4</p>
	...
	<div class="prod_box">
		<div class="frame">
			<img src="img/htcm9.png" alt="m9" width="162" height="168">
		</div>

		<p class="title">HTC M9+</p>
